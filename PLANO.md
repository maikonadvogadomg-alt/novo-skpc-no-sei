...
> Gerado automaticamente pelo SK Code Editor em 26/04/2026, 20:03:58
> **111 arquivo(s)** | **~26.357 linhas de codigo**
...
Arquivos: 111 | Linhas: ~26.357
Rotas API: 18 endpoint(s) detectado(s)
Variaveis de ambiente necessarias: PORT, ALLOWED_ORIGINS, JWT_SECRET, JWT_EXPIRES_IN, DATABASE_URL, BASE_PATH, REPL_ID
...
*Plano gerado pelo SK Code Editor — 26/04/2026, 20:03:58*